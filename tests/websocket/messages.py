...
def on_message(ws, message):
    ...
    if data['type'] == 'server_aes':
        ...
        response = requests.post(
            ...
            cookies={
                'session': 'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJ1c2VyIjp7InVzZXJuYW1lIjoiVHJhcGEiLCJfaWQiOiI2NDQxYWU3MTA3NmE5NTE1MDlmMDJmNjYifSwiaWF0IjoxNjk4Njk5OTI0LCJleHAiOjE2OTkzMDQ3MjR9.lVX5w2UR1p8OVbYnF6TzjEW8pYAKekfnxg5p6iu6-xw'
            }
        ).json()
        print(response)
        said = response['said']
